...
function preloadImageRatios(models) {
  ...
  models.forEach(function (m) {
    ...
    img.onload = function () { rememberImageRatio(m.id, img); };
...
function useVirtualImages(containerRef) {
  var _active = React.useState(function () { return new Set(); });
  ...
  React.useEffect(function () {
    ...
    function scan() {
      ...
      active.forEach(function (id) {
        if (!currentIds.has(id)) { active.delete(id); changed = true; }
      });
    ...
    var imgObs = new IntersectionObserver(function (entries) {
      ...
      entries.forEach(function (e) {
        ...
        if (!id) return;
        if (e.isIntersecting) {
          if (!active.has(id)) { active.add(id); changed = true; }
        } else {
    ...
    return function () { imgObs.disconnect(); mutObs.disconnect(); };
  }, [containerRef]);
